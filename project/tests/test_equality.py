...
class TestsForElement    (unittest.TestCase):
    ...
    @staticmethod
    def create_Element(): return Node(type    ="foo",
                                      args    =("hello",{"world":123}),
                                      children=[Node(type="bar"), Node(type="John", args={"The answer":42})])
