...
def process(zfn:str, p:typing.Callable[[str,io.BytesIO],None]):
    ...
    for fn, f in internal_files_by_name(zfn):
...
def count_types_all(zfn:str):
    ...
    return {fn:count_types(f) for fn,f in internal_files_by_name(zfn)}
...
if __name__ == '__main__':
    ...
    for zfn in (
        ...
        print(zfn,end='\n\n')
        print('\n'.join(fn for fn,f in internal_files_by_name(zfn)), end='\n\n')
